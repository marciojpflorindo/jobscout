...
# no waiting. (To search for new jobs, double-click 2-search-jobs.command instead.)
#
# It's a thin wrapper: it just runs 2-search-jobs.command in view-only mode.
...
exec ./2-search-jobs.command --no-search
